"""(4) Convergence study -- Newton (XPBD) side, Stage A hanging block.
...
solver-error picture; the FEM half is fenics_run/convergence_stage_a.py.
...
from newton_run.run_stage_a import simulate
...
def main():
    parser = argparse.ArgumentParser(description="Newton XPBD convergence (Stage A)")
