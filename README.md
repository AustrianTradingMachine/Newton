...
| **indentation** | a rigid sphere is pressed into a soft slab | FEM gives a calibrated contact-force curve; XPBD only gives deformation |
| **drop** | a sphere is dropped onto a block (dynamic impact) | transient impact; FEM Newmark + contact vs. XPBD |
