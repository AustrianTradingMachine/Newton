...
- Colab result numbers are **observations** (Python 3.12, dolfinx 0.11.0.post0, Warp 1.14.0), recorded with provenance — not eternal "verified" claims. `TODO[verify-on-colab]` marks what still needs a GPU run.
